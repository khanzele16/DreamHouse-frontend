      ...
      >
        <div className="max-w-4xl w-full lg:w-[800px]">
          <div className="flex lg:justify-start justify-center lg:content-start content-center items-center max-[1150px]:gap-x-[4px] gap-x-[10px] mb-4">
            <Link className="flex justify-center content-center items-center" href="/">
              <svg
                width="41"
                height="66"
            ...
            <div className="space-y-5">
              <label className="block">
                ...
                <input
                  ...
                  autoComplete="name"
                  className="mt-2 block w-full rounded-lg border px-4 py-3 focus:outline-none focus:ring-2 font-[family-name:var(--font-stetica-regular)]"
                />
                {errors.name && (
